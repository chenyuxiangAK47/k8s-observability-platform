...
# This Terraform configuration creates a complete EKS cluster with all necessary resources
...
resource "aws_eks_node_group" "main" {
  ...
  # Use cluster's current version instead of forcing a specific version
  # This allows the node group to match the cluster version
