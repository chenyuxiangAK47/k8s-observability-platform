...
2. ✅ 使用 Helm Chart 管理所有组件
3. ✅ 集成 Prometheus Operator
4. ✅ 添加 HPA 自动扩缩容
...
```
.
├── services/                      # 微服务源代码（包含 OpenTelemetry）
│   ├── user-service/
│   ├── product-service/
│   └── order-service/
├── helm/                          # Helm Charts
│   ├── observability-platform/   # 可观测性平台Chart
│   └── microservices/             # 微服务Chart
├── k8s/                           # Kubernetes 原生配置
│   ├── namespaces/                # 命名空间配置
│   ├── monitoring/                 # 监控相关配置
│   ├── services/                  # 微服务部署配置
...
- **product-service**: 商品管理服务（端口 8002）
- **order-service**: 订单管理服务（端口 8003）
